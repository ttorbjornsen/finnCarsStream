...
object ExtractDetails {
  ...
  /* TODO separate into KafkaProducer object */
  ...
  def getCars(date:String): = {

  }


  def produceCarsDetailKafkaMessage(url:String) = {
      val url = "http://m.finn.no/car/used/ad.html?finnkode=78601940" //temp
